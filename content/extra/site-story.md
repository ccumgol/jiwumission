...
<!-- CHANGELOG:START -->
- **2026-08-11** — 썸네일 사진 이름 변경
- **2026-08-10** — 정적홈페이지 동영상 5 업로드
- **2026-08-09** — 그림파일링크 추가
- **2026-08-09** — 잎새 43호
- **2026-08-03** — 코드수정
- **2026-08-03** — fix: 성경개론 QT 링크 누락 해결 — 평문 범위 줄도 인식 (이사야 18→52링크)
- **2026-08-03** — feat: 성경개론을 66권 전체 목록 전용 페이지로 재구성
- **2026-08-02** — 잎새 42호
- **2026-07-31** — fix: 야간 자동화 정리 — 사용 중지된 스크립트 제거, QT 링크 스크립트 경로 수정, 06:00 재빌드 중단
- **2026-07-30** — 토글 버튼
- **2026-07-30** — fix: frontmatter의 대문자 Categories를 소문자 categories로 정규화 (31개 파일)
- **2026-07-30** — 무료 정적홈페이지 완성 가이드 - 날짜 수정
- **2026-07-30** — feat: 사이트 제작기 변경 이력 정렬 토글(최신순/오래된순) 추가
- **2026-07-30** — docs: 사이트 제작기 변경 기록 갱신 (07-22 이후 반영, 160항목) + test 커밋 제외 규칙 추가
- **2026-07-30** — 정적홈페이지 완성 가이드
- **2026-07-26** — 잎새 41호
- **2026-07-25** — docs: Hugo 테마 275선 문서 썸네일 이미지 추가
- **2026-07-25** — Hugo Template 정리
- **2026-07-22** — IT News 폴더 지침 조정
- **2026-07-22** — docs: 사이트 제작기 변경 기록 갱신 (154항목)
