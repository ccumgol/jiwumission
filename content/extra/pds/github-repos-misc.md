...
author: "Gihyun Park"
summary: "위 분류에 들어가지 않는 프로젝트 분야의 오픈소스 리포지터리 4개 목록입니다."
description: "위 분류에 들어가지 않는 프로젝트 분야의 오픈소스 리포지터리 4개 목록입니다."
categories: ["오픈소스", "자료실"]
tags: ["GitHub", "오픈소스"]
type: "post"
comments: false
...
위 분류에 들어가지 않는 프로젝트. 현재 **4개**이며, 매일 IT 뉴스 브리핑에서 새 프로젝트를 소개할 때마다 추가됩니다.
