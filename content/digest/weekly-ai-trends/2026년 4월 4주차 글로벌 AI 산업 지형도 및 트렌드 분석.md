...
author: "Gihyun Park"
lastmod: 2026-06-13
summary: "OpenAI, Google, Salesforce가 4월 22일에 에이전트 플랫폼을 동시에 공개해 에이전트 OS 경쟁이 시작됐으며, DeepSeek V4와 HBM4 확대로 추론 비용이 감소하고 전력 수요가 증가하고, RSAC 발표를 통해 보안·거버넌스 표준인 UCP와 AAIF가 본격화되었습니다."
description: "OpenAI, Google, Salesforce가 4월 22일에 에이전트 플랫폼을 동시에 공개해 에이전트 OS 경쟁이 시작됐으며, DeepSeek V4와 HBM4 확대로 추론 비용이 감소하고 전력 수요가 증가하고, RSAC 발표를 통해 보안·거버넌스 표준인 UCP와 AAIF가 본격화되었습니다."
tags: ["잎새 28호"]
